...
/// mapa. Eso es lo que permite que la Sala de Situación y la futura página de
/// detalle ampliada compartan un único renderizador en vez de duplicarlo
/// [diseño D7]: el host pone el estado, el contenido pone los píxeles.
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            crimeCase.title,
            style: SituationStyles.serif(size: 32, height: 1.04),
          ),
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                SituationDot(
                  color: related.crimeCase.category.presentation.color,
                ),
                const SizedBox(width: 11),
                Expanded(
                  child: Column(
